  ...
  return (
    <>
      <div className="w-[90vw]  tablet:mt-0 mx-auto max-w-[1280px]">
        <div className="w-full grid grid grid-cols-1 laptop:grid-cols-3 tablet:grid-cols-2 gap-5 tablet:gap-2 tablet:gap-y-4 tablet:justify-between justify-center flex-wrap  *:max-w-[430px] *:tablet:max-w-full *:bg-white  *:shadow-sm  *:rounded-[10px] *:border-[0.5px] *:border-[#E9EAF2] *:p-5 *:tablet:p-[30px] ">
          <div className=" w-full nine:w-[49.2%] laptop:w-[32.333%] mb-4">
            <div className=" justify-start items-center gap-2 ">
              ...
              <h2 className="text-base mt-2 tablet:leading-9 leading-6 font-bold text-[#040A33]">
                Effortlessly search for jobs.
              </h2>
              <p className="text-sm text-left mt-2 text-[#555973]">
          ...
          <div className=" w-full nine:w-[49.2%] laptop:w-[32.333%] mb-4 !bg-[#0967D2] ">
            <div className=" justify-center items-center gap-2 text-center">
              <h2 className="text-base mt-4 tablet:leading-9 leading-6 font-bold text-[#fff]">
                Don’t miss out, join over 10,000+ job seekers and start
                applying. 🥳💃🕺🪩☺️🙌
              </h2>
              <button className="mt-4 border-[0.5px] border-0 py-2 bg-[#fff] md:py-[10px] px-5 md:px-[25px] rounded-xl text-[#0967d2] text-base font-normal">
                Join the waitlist
              </button>
            </div>
          </div>
